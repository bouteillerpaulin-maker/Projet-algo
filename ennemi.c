...
SpritesEnnemi charger_sprites_ennemi(void) {
    ...
    s.haut[0]  = al_load_bitmap("Ennemis\\ennehaut1.png");
    s.haut[1]  = al_load_bitmap("Ennemis\\ennehaut2.png");
    s.bas[0]   = al_load_bitmap("Ennemis\\ennebas1.png");
    s.bas[1]   = al_load_bitmap("Ennemis\\ennebas2.png");
    s.droite[0]= al_load_bitmap("Ennemis\\ennedr1.png");
    s.droite[1]= al_load_bitmap("Ennemis\\ennedr2.png");
    s.gauche   = al_load_bitmap("Ennemis\\ennegh2.png");
